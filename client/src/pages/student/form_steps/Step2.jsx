...
const Step2 = ({ setActiveStep, oldFormData }) => {
  ...
  const onSubmit = async (data) => {
    ...
    fields.forEach(({ section, inputs }) => {
      const sectionData = section.split('.').reduce((obj, key) => obj && obj[key], data);
      if (sectionData) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="col-md-3" key={input.name}>
              <div className="form-group">
                ...
                <input
                  ...
                  type="text"
                  {...register(
                    `competitiveExamScore[${index}].${input.name}`
                  )}
                  aria-invalid={
      ...
      <button
        ...
        onClick={() => append({ competativeName: "", competativeDate: "", competativeObtMarks: "", competativeMaxMarks: "" })}
      >
